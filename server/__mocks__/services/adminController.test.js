...
describe('Admin Controller - Users', () => {
    let req, res;
    let handleGetAllUsers, handleCreateUser, handleGetUserById, handleUpdateUser, handleGetAllPosts,
        handleCreatePost,
        handleGetPostById,
        handleUpdatePost,
        handleDeletePost, handleGetBlogById,
        handleDeleteBlog,
        handleGetAllTopics,
        handleCreateTopic,
        handleUpdateTopic, handleToggleBanUser,
    ...
    beforeEach(async () => {
        ...
        handleGetAllPosts = controller.handleGetAllPosts;
        handleCreatePost = controller.handleCreatePost;
        handleGetPostById = controller.handleGetPostById;
        handleUpdatePost = controller.handleUpdatePost;
        handleDeletePost = controller.handleDeletePost;
        handleGetBlogById = controller.handleGetBlogById;
        handleDeleteBlog = controller.handleDeleteBlog;
        handleGetAllTopics = controller.handleGetAllTopics;
        handleCreateTopic = controller.handleCreateTopic;
        handleUpdateTopic = controller.handleUpdateTopic;
        handleToggleBanUser = controller.handleToggleBanUser;
        handleGetAllUserSubscriptions = controller.handleGetAllUserSubscriptions;
        handleCreateUserSubscription = controller.handleCreateUserSubscription;
        handleUpdateUserSubscription = controller.handleUpdateUserSubscription;
        handleDeleteUserSubscription = controller.handleDeleteUserSubscription;
