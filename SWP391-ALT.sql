...
-- Fixed: coach_reviews with multiple FKs to users
...
-- Fixed: coach_user with multiple FKs to users  
ALTER TABLE [coach_user] ADD FOREIGN KEY ([user_id]) REFERENCES [users] ([user_id]) ON DELETE CASCADE;
...
-- Fixed: user_notes with multiple FKs to users
...
ALTER TABLE [user_achievements] ADD FOREIGN KEY ([achievement_id]) REFERENCES [achievements] ([achievement_id]) ON DELETE NO ACTION;
...
ALTER TABLE [blog_posts] ADD FOREIGN KEY ([topic_id]) REFERENCES [Topics] ([topic_id]) ON DELETE CASCADE;

ALTER TABLE [social_posts] ADD FOREIGN KEY ([category_id]) REFERENCES [social_category] ([category_id]) ON DELETE CASCADE;
ALTER TABLE [social_posts] ADD FOREIGN KEY ([user_id]) REFERENCES [users] ([user_id]) ON DELETE CASCADE;

-- Fixed: social_comments with cascade conflict through social_posts
...
ALTER TABLE [social_comments] ADD FOREIGN KEY ([parent_comment_id]) REFERENCES [social_comments] ([comment_id]) ON DELETE NO ACTION;

-- Fixed: social_likes with cascade conflict through social_posts/social_comments 
...
-- Fixed: social_reports with cascade conflict through social_posts/social_comments
