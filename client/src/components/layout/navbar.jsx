                ...
                <div className="flex justify-between items-center h-16 gap-5">
                    ...
                    <div className="hidden md:flex justify-between items-center w-full">
                        <div className="w-[50%] flex gap-10">
                            <a onClick={() => navigate('/')}
                               className="cursor-pointer text-white hover:text-primary-500 font-medium transition-colors">
                                Trang chủ
                            </a>
                            ...
                            <a onClick={() => navigate('/topics')}
                               className="text-white hover:text-primary-500 font-medium transition-colors">
                                <TopicsDropdown/>
                            </a>

                            {isAuthenticated === true && userInfo?.role !== 'Coach' && (
                                <a onClick={() => navigate('/coach-register')}
                                   className="text-white cursor-pointer hover:text-primary-500 font-medium transition-colors">
                                    Trở thành HLV
                                </a>
                            )}
