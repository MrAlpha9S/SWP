...
function Hero({title, heroHeight = 188}) {

    const {user, isAuthenticated} = useAuth0()

    return (
        <section style={{height : heroHeight, transition: 'height 0.2s'}} className="sticky top-[80px] z-50 py-16 md:py-8 min-h-[50px] bg-primary-100">
