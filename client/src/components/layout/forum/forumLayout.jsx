        ...
        <div className="bg-white ">
            ...
            <div className="max-w-7xl mx-auto px-10 py-10 grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="space-y-4">
                    <Sidebar keyword={keyword} setKeyword={setKeyword} selectedCategory={selectedCategory}
                             setSelectedCategory={setSelectedCategory} setToDate={setToDate} setFromDate={setFromDate}
