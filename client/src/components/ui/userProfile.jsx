...
import {getBackendUrl, getFrontEndUrl} from "../utils/getBackendURL.js";
...
const Profile = () => {
    ...
    items.push({
        ...
        label: (
            <a
                href={`https://${import.meta.env.VITE_AUTH0_DOMAIN}/v2/logout?returnTo=${getFrontEndUrl()}&client_id=${import.meta.env.VITE_AUTH0_CLIENT_ID}`}
            >
                Đăng xuất
            </a>
        ),
